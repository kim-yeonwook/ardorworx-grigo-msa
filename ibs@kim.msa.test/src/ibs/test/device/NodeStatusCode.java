...
public enum NodeStatusCode implements Code {
	...
	private NodeStatusCode(String code, int state, String desc) {
		this.state = state;
		this.code = code;
		this.desc = desc;
	}
	private NodeStatusCode(String code, int state, String desc, int action) {
		this.state = state;
		this.code = code;
		this.desc = desc;
		this.action = action;
